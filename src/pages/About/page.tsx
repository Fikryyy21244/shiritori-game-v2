    ...
    <div className="w-full my-10">
      ...
      <div className="flex flex-col items-center text-center gap-4">
        <div className="inline-flex items-center gap-3 rounded-full border border-pink-400/20 bg-pink-400/10 px-5 py-2 backdrop-blur-md">
          ...
          <span className="text-sm font-bold tracking-[0.2em] text-pink-300">
            ABOUT PROJECT
          </span>
        </div>

        <h1 className="font-jaro text-6xl uppercase tracking-[0.2em] text-pink-400 drop-shadow-[0_0_25px_rgba(244,114,182,0.35)]">
          Tentang
        </h1>
      ...
      <div className="mt-8">
        ...
        >
          <FaArrowLeftLong className="text-pink-300 transition-transform duration-300 group-hover:-translate-x-1" />
      ...
      <div className="relative mt-10 overflow-hidden rounded-4xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
        ...
        <div className="relative z-10 grid gap-8 md:grid-cols-[1fr_1.2fr] items-center">
          ...
          <div className="flex flex-col gap-5">
            <div className="w-fit rounded-full border border-pink-400/20 bg-pink-400/10 px-4 py-1 text-sm font-bold tracking-[0.2em] text-pink-300">
              SHIRITORI GAME
            </div>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <div className="rounded-2xl border border-yellow-400/20 bg-yellow-400/10 px-4 py-2 text-yellow-300">
                TailwindCSS
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-5">
            <div className="group rounded-4xl border border-white/10 bg-black/30 p-6 transition-all duration-300 hover:-translate-y-2 hover:border-pink-400/30 hover:bg-white/10">
              ...
              <h3 className="mt-5 text-2xl font-bold text-white">Gameplay</h3>
            ...
            <div className="group rounded-4xl border border-white/10 bg-black/30 p-6 transition-all duration-300 hover:-translate-y-2 hover:border-yellow-400/30 hover:bg-white/10">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-yellow-400/10 text-2xl text-yellow-300">
                <FaCode />
              </div>

              <p className="mt-2 leading-relaxed text-gray-400">
                Menggunakan desain modern glassmorphism anime style.
              </p>
            </div>
            ...
            <div className="group rounded-4xl border border-white/10 bg-black/30 p-6 transition-all duration-300 hover:-translate-y-2 hover:border-cyan-400/30 hover:bg-white/10">
              ...
              <h3 className="mt-5 text-2xl font-bold text-white">Learning</h3>
      ...
      <div className="relative mt-10 overflow-hidden rounded-4xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-4">
          <h3 className="text-4xl font-black text-white">しりとりゲーム</h3>
